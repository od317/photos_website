...
function NavBar() {
  ...
  <NavLink to={'/'} className=''>
      <svg 
      class="gUZ GjR U9O kVc" height="24" width="24" viewBox="0 0 24 24" fill="#e60023"
  ...
  <NavLink to={'/'} className=' sm:w-[10%]  md:w-[8%] lg:w-[6%]  mx-[1%]  rounded-full text-center py-[.2%] text-black'>Home</NavLink>
  </>
  )
  ...
  return (<>
    <nav className=' hidden sm:block sticky top-0  bg-white'>
         <Form logoSection={logoSection} savedIconSection={savedIconSection}></Form>
    </nav>
    <div className='sm:hidden fixed bottom-0 w-full flex justify-evenly bg-red-500 py-[1%] flex-row'>
